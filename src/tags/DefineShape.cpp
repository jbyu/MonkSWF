...
void barycentric(const POINTf& p, const POINTf& a, const POINTf& b, const POINTf& c, float &u, float &v)
{
    POINTf v0 = b - a, v1 = c - a, v2 = p - a;
    float d00 = v0.dot(v0);
    float d01 = v0.dot(v1);
	float d02 = v0.dot(v2);
    float d11 = v1.dot(v1);
...
bool ShapeWithStyle::Mesh::isInsideMesh(const POINTf& pt) const {
	float u, v;
